...
declare function hdPreset(options: WidthPresetOptions): {
    ...
    images: ImageSource[];
    inferDimensions: boolean | undefined;
};
declare function widthPreset({ density, widths, formats, resizeOptions, withImage, inferDimensions, ...options }: WidthPresetOptions): ImagePreset;
...
declare function densityPreset({ baseWidth, baseHeight, density, formats, resizeOptions, withImage, inferDimensions, ...options }: DensityPresetOptions): ImagePreset;
