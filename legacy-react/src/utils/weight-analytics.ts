...
class WeightAnalytics {
  ...
  completeStep(
    params: Omit<WeightAnalyticsEvents["step_completed"], "time_spent_seconds">,
  ) {
  ...
  trackSave(
    params: Omit<
      WeightAnalyticsEvents["measurement_saved"],
      | "total_flow_time_seconds"
      | "steps_back_navigated"
      | "used_healthkit"
      | "used_presets"
    >,
  ) {
