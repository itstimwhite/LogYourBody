...
export function EmailConfirmationBanner() {
  ...
  useEffect(() => {
    ...
    const needsConfirmation = localStorage.getItem(
      ...
      <AlertDescription className="flex w-full items-center justify-between">
        ...
        <div className="ml-4 flex items-center gap-2">
          <Button
            ...
            className="h-8 border-blue-300 text-xs text-blue-700 hover:bg-blue-100 dark:border-blue-700 dark:text-blue-300 dark:hover:bg-blue-900"
          >
            Resend
          </Button>
          <Button
