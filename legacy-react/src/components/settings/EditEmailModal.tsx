...
export const EditEmailModal = React.memo<EditEmailModalProps>(
  function EditEmailModal({ isOpen, onClose, currentEmail, onSave }) {
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              <div className={tw.helperText}>{value.length}/100 characters</div>
            </div>
          </div>
