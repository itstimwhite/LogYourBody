...
export const EditBirthdayModal = React.memo<EditBirthdayModalProps>(
  function EditBirthdayModal({ isOpen, onClose, currentBirthday, onSave }) {
      ...
      >
        <div className="space-y-6">
          ...
          <div className="text-center">
            <div className={tw.itemTitle}>Selected Date</div>
