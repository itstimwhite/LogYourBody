import{j as e}from"./ui-vendor-B29bBmtv.js";import{u as k,k as F,R as N}from"./react-vendor-CGPzL8fz.js";import{B as r,a as d,C as x,b as j,d as T,e as I,f as M}from"./index-BXn5fie0.js";import{p as a}from"./prefetch-DuFvdqm2.js";import{F as f}from"./Footer-BWGpOqSu.js";import{U as b,b as v,m as u,A as h,ae as S,af as B,e as A,ag as C}from"./utils-vendor-eZsCaz-O.js";import"./data-vendor-CtvEhjhB.js";import"./analytics-vendor-CXgENQ1a.js";import"./VersionDisplay-hsVI5a3E.js";const g={"what-is-ffmi-and-why-it-matters":{slug:"what-is-ffmi-and-why-it-matters",title:"What is FFMI and Why It Matters More Than Body Weight",date:"2025-01-15",author:"Tim White",tags:["FFMI","Body Composition","Muscle Building","Science"],excerpt:"FFMI (Fat-Free Mass Index) is the most accurate way to track muscle building progress. Unlike body weight or BMI, FFMI tells you exactly how much muscle you're gaining relative to your height.",readTime:"5 min read",formattedDate:"January 15, 2025",content:`# What is FFMI and Why It Matters More Than Body Weight
...
*Tim White spent years using ice baths religiously until discovering they were hindering his muscle building progress. He now focuses on evidence-based recovery methods and has seen better results than ever.*`}},W=()=>Object.values(g).sort((s,l)=>new Date(l.date).getTime()-new Date(s.date).getTime()),E=s=>g[s]||null,R=()=>{const s=new Set;return Object.values(g).forEach(l=>{l.tags.forEach(i=>s.add(i))}),Array.from(s).sort()},U=()=>{const s=k(),{slug:l}=F(),[i,p]=N.useState(null),m=W(),w=R(),n=l?E(l):null,c=i?m.filter(t=>t.tags.includes(i)):m,o=m[0];return n?e.jsxs("div",{className:"min-h-svh bg-linear-bg font-inter",children:[e.jsx("header",{className:"border-b border-linear-border",role:"banner",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6 py-4",children:e.jsxs("nav",{className:"flex items-center justify-between",children:[e.jsx("button",{onClick:()=>s("/"),onMouseEnter:()=>a("/"),onFocus:()=>a("/"),className:"text-lg sm:text-xl font-semibold text-linear-text hover:text-linear-text-secondary transition-colors",children:"LogYourBody"}),e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsx(r,{variant:"ghost",onClick:()=>s("/blog"),onMouseEnter:()=>a("/blog"),className:"text-sm text-linear-text-secondary hover:text-linear-text",children:"← Back to Blog"}),e.jsx(r,{variant:"ghost",onMouseEnter:()=>a("/login"),onFocus:()=>a("/login"),onClick:()=>s("/login"),className:"text-sm text-linear-text-secondary hover:text-linear-text",children:"Log in"}),e.jsx(r,{onMouseEnter:()=>a("/login"),onFocus:()=>a("/login"),onClick:()=>s("/login"),className:"bg-linear-text text-linear-bg text-sm font-medium px-4 py-2 rounded-lg hover:bg-linear-text-secondary transition-colors",children:"Sign up"})]})]})})}),e.jsx("main",{className:"container mx-auto px-4 sm:px-6 py-12",children:e.jsxs("article",{className:"max-w-4xl mx-auto",children:[e.jsxs("header",{className:"mb-12",children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:n.tags.map(t=>e.jsx(d,{variant:"secondary",className:"text-xs",children:t},t))}),e.jsx("h1",{className:"text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-linear-text mb-6",children:n.title}),e.jsxs("div",{className:"flex items-center gap-6 text-sm text-linear-text-secondary",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(b,{className:"h-4 w-4"}),n.author]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(v,{className:"h-4 w-4"}),n.formattedDate]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(u,{className:"h-4 w-4"}),n.readTime]})]})]}),e.jsx("div",{className:"prose prose-lg max-w-none",children:e.jsx("div",{className:"text-linear-text-secondary leading-relaxed",dangerouslySetInnerHTML:{__html:n.content.replace(/^# /gm,'<h1 class="text-3xl font-bold text-linear-text mt-8 mb-4">').replace(/^## /gm,'<h2 class="text-2xl font-semibold text-linear-text mt-8 mb-4">').replace(/^### /gm,'<h3 class="text-xl font-semibold text-linear-text mt-6 mb-3">').replace(/\*\*(.*?)\*\*/g,'<strong class="font-semibold text-linear-text">$1</strong>').replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,'<code class="bg-linear-card px-2 py-1 rounded text-sm font-mono">$1</code>').replace(/```([^```]+)```/gs,'<pre class="bg-linear-card p-4 rounded-lg overflow-x-auto"><code class="font-mono text-sm">$1</code></pre>').replace(/^\| (.*) \|$/gm,'<div class="table-row">$1</div>').replace(/\n\n/g,'</p><p class="mb-4">').replace(/^(?!<[h|p|d])/gm,'<p class="mb-4">')+"</p>"}})}),e.jsxs("div",{className:"mt-12 p-8 bg-linear-card/30 rounded-xl border border-linear-border",children:[e.jsx("h3",{className:"text-xl font-semibold text-linear-text mb-4",children:"Ready to Start Tracking?"}),e.jsx("p",{className:"text-linear-text-secondary mb-6",children:"Join thousands of people using LogYourBody to track what really matters for their fitness journey."}),e.jsxs(r,{onClick:()=>s("/login"),onMouseEnter:()=>a("/login"),className:"bg-linear-text text-linear-bg hover:bg-linear-text-secondary",children:["Start Free Trial",e.jsx(h,{className:"h-4 w-4 ml-2"})]})]})]})}),e.jsx(f,{})]}):e.jsxs("div",{className:"min-h-svh bg-linear-bg font-inter",children:[e.jsx("header",{className:"border-b border-linear-border",role:"banner",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6 py-4",children:e.jsxs("nav",{className:"flex items-center justify-between",children:[e.jsx("button",{onClick:()=>s("/"),onMouseEnter:()=>a("/"),onFocus:()=>a("/"),className:"text-lg sm:text-xl font-semibold text-linear-text hover:text-linear-text-secondary transition-colors",children:"LogYourBody"}),e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsx(r,{variant:"ghost",onMouseEnter:()=>a("/login"),onFocus:()=>a("/login"),onClick:()=>s("/login"),className:"text-sm text-linear-text-secondary hover:text-linear-text",children:"Log in"}),e.jsx(r,{onMouseEnter:()=>a("/login"),onFocus:()=>a("/login"),onClick:()=>s("/login"),className:"bg-linear-text text-linear-bg text-sm font-medium px-4 py-2 rounded-lg hover:bg-linear-text-secondary transition-colors",children:"Sign up"})]})]})})}),e.jsxs("main",{children:[e.jsx("section",{className:"py-16 md:py-24",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6",children:e.jsxs("div",{className:"mx-auto max-w-4xl text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 mb-6",children:[e.jsx(S,{className:"h-8 w-8 text-linear-purple"}),e.jsx(d,{className:"bg-linear-purple/10 text-white border-linear-purple/20",children:"Evidence-Based Content"})]}),e.jsxs("h1",{className:"mb-6 text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-linear-text",children:["The LogYourBody",e.jsx("br",{}),e.jsx("span",{className:"bg-linear-to-r from-linear-purple via-linear-text to-linear-purple bg-clip-text text-transparent",children:"Blog"})]}),e.jsx("p",{className:"mx-auto mb-8 max-w-2xl text-lg text-linear-text-secondary",children:"Science-based articles about body composition, fitness tracking, and building sustainable habits. No fluff, just actionable insights backed by research."})]})})}),e.jsx("section",{className:"py-8 border-y border-linear-border bg-linear-card/20",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6",children:e.jsxs("div",{className:"flex flex-wrap gap-2 justify-center",children:[e.jsx(r,{variant:i===null?"default":"outline-solid",size:"sm",onClick:()=>p(null),className:i===null?"bg-linear-text text-linear-bg":"",children:"All Posts"}),w.map(t=>e.jsxs(r,{variant:i===t?"default":"outline-solid",size:"sm",onClick:()=>p(t),className:i===t?"bg-linear-text text-linear-bg":"",children:[e.jsx(B,{className:"h-3 w-3 mr-1"}),t]},t))]})})}),!i&&e.jsx("section",{className:"py-16",children:e.jsxs("div",{className:"container mx-auto px-4 sm:px-6",children:[e.jsx("div",{className:"mb-8",children:e.jsx("h2",{className:"text-2xl font-bold text-linear-text mb-4",children:"Featured Article"})}),e.jsx(x,{className:"border-linear-border bg-linear-card/50 overflow-hidden",children:e.jsxs("div",{className:"md:flex",children:[e.jsx("div",{className:"md:w-1/3 bg-linear-to-br from-linear-purple/20 to-linear-purple/5 p-8 flex items-center justify-center",children:e.jsx(A,{className:"h-16 w-16 text-white"})}),e.jsxs("div",{className:"md:w-2/3 p-8",children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:o.tags.map(t=>e.jsx(d,{variant:"secondary",className:"text-xs",children:t},t))}),e.jsx("h3",{className:"text-2xl font-bold text-linear-text mb-4",children:o.title}),e.jsx("p",{className:"text-linear-text-secondary mb-6",children:o.excerpt}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4 text-sm text-linear-text-secondary",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(b,{className:"h-4 w-4"}),o.author]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(u,{className:"h-4 w-4"}),o.readTime]})]}),e.jsxs(r,{onClick:()=>s(`/blog/${o.slug}`),onMouseEnter:()=>a(`/blog/${o.slug}`),className:"bg-linear-text text-linear-bg hover:bg-linear-text-secondary",children:["Read Article",e.jsx(h,{className:"h-4 w-4 ml-2"})]})]})]})]})})]})}),e.jsx("section",{className:"py-16",children:e.jsxs("div",{className:"container mx-auto px-4 sm:px-6",children:[e.jsxs("div",{className:"mb-8",children:[e.jsx("h2",{className:"text-2xl font-bold text-linear-text mb-4",children:i?`Posts tagged "${i}"`:"Latest Articles"}),e.jsxs("p",{className:"text-linear-text-secondary",children:[c.length," article",c.length!==1?"s":""]})]}),e.jsx("div",{className:"grid gap-8 md:grid-cols-2 lg:grid-cols-3",children:c.map(t=>e.jsxs(x,{className:"border-linear-border bg-linear-card group hover:shadow-lg transition-all",children:[e.jsxs(j,{children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-3",children:t.tags.slice(0,2).map(y=>e.jsx(d,{variant:"secondary",className:"text-xs",children:y},y))}),e.jsx(T,{className:"text-lg text-linear-text group-hover:text-linear-purple transition-colors",children:t.title}),e.jsx(I,{className:"text-linear-text-secondary",children:t.excerpt})]}),e.jsxs(M,{children:[e.jsx("div",{className:"flex items-center justify-between mb-4",children:e.jsxs("div",{className:"flex items-center gap-3 text-sm text-linear-text-secondary",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(v,{className:"h-3 w-3"}),t.formattedDate]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(u,{className:"h-3 w-3"}),t.readTime]})]})}),e.jsxs(r,{variant:"ghost",className:"w-full justify-between text-linear-text-secondary hover:text-linear-text hover:bg-linear-purple/10 transition-colors",onClick:()=>s(`/blog/${t.slug}`),onMouseEnter:()=>a(`/blog/${t.slug}`),children:["Read Article",e.jsx(h,{className:"h-4 w-4"})]})]})]},t.slug))}),c.length===0&&e.jsxs("div",{className:"text-center py-12",children:[e.jsx(C,{className:"h-12 w-12 text-linear-text-secondary mx-auto mb-4"}),e.jsx("h3",{className:"text-xl font-semibold text-linear-text mb-2",children:"No articles found"}),e.jsx("p",{className:"text-linear-text-secondary",children:"Try selecting a different tag or view all posts."})]})]})}),e.jsx("section",{className:"py-16 bg-linear-card/30",children:e.jsxs("div",{className:"container mx-auto px-4 sm:px-6 text-center",children:[e.jsx("h2",{className:"text-3xl font-bold text-linear-text mb-4",children:"Stay Updated"}),e.jsx("p",{className:"text-linear-text-secondary mb-8 max-w-2xl mx-auto",children:"Get notified when we publish new evidence-based articles about body composition, fitness tracking, and sustainable health habits."}),e.jsxs(r,{onClick:()=>s("/login"),onMouseEnter:()=>a("/login"),className:"bg-linear-text text-linear-bg hover:bg-linear-text-secondary",children:["Join LogYourBody",e.jsx(h,{className:"h-4 w-4 ml-2"})]})]})})]}),e.jsx(f,{})]})};export{U as default};
