...
class HealthKitManager: ObservableObject {
    ...
    private func saveBodyMetrics(_ metrics: BodyMetrics) async throws {
        ...
        // Save directly to CoreData and mark as synced (no need to sync HealthKit data to server)
        await MainActor.run {
            CoreDataManager.shared.saveBodyMetrics(metricsWithUserId, userId: userId, markAsSynced: true)
        }
    }
