import{j as e}from"./ui-vendor-BTNJdHiL.js";import{u as k,k as M,R as T}from"./react-vendor-CGPzL8fz.js";import{B as n,a as d,C as f,b as S,d as F,e as P,f as B}from"./index-BWixOZri.js";import{p as i}from"./prefetch-BKo02pYs.js";import{F as b}from"./Footer-CHoD0jbK.js";import{U as x,b as w,o as m,A as u,ae as N,af as I,g as j,ag as C}from"./utils-vendor-BD55slVq.js";import"./data-vendor-Dz4nk24n.js";import"./analytics-vendor-CXgENQ1a.js";import"./VersionDisplay-BrEkyV1W.js";const g={"what-is-ffmi-and-why-it-matters":{slug:"what-is-ffmi-and-why-it-matters",title:"What is FFMI and Why It Matters More Than Body Weight",date:"2025-01-15",author:"Tim White",tags:["FFMI","Body Composition","Muscle Building","Science"],excerpt:"FFMI (Fat-Free Mass Index) is the most accurate way to track muscle building progress. Unlike body weight or BMI, FFMI tells you exactly how much muscle you're gaining relative to your height.",readTime:"5 min read",formattedDate:"January 15, 2025",content:`# What is FFMI and Why It Matters More Than Body Weight
...
*Tim White is the founder of LogYourBody and has been tracking body composition metrics for over a decade. He believes in science-based approaches to fitness that focus on what actually matters.*`},"walking-steps-neat-fitness-efficiency":{slug:"walking-steps-neat-fitness-efficiency",title:"Why Walking Beats HIIT for Fat Loss: The Science of NEAT and Area Under the Curve",date:"2025-01-14",author:"Tim White",tags:["Walking","NEAT","Fat Loss","Step Count","Cardio"],excerpt:"Walking has the largest area under the curve for calorie burn with the least fatigue. Here's why step count matters more than intense workouts for sustainable fat loss.",readTime:"6 min read",formattedDate:"January 14, 2025",content:`# Why Walking Beats HIIT for Fat Loss: The Science of NEAT and Area Under the Curve
...
*Tim White founded LogYourBody after discovering that consistent walking habits contributed more to his physique than years of intense gym sessions. He now walks 12,000+ steps daily while running a tech company.*`},"evidence-based-body-recomposition":{slug:"evidence-based-body-recomposition",title:"Evidence-Based Body Recomposition: The Science of Building Muscle While Losing Fat",date:"2025-01-17",author:"Tim White",tags:["Body Recomposition","Fat Loss","Muscle Building","Science","Evidence-Based"],excerpt:"Discover the science behind simultaneous muscle gain and fat loss. Learn who can successfully recomp, optimal caloric strategies, and realistic timelines based on peer-reviewed research.",readTime:"9 min read",formattedDate:"January 17, 2025",content:`# Evidence-Based Body Recomposition: The Science of Building Muscle While Losing Fat
...
*Tim White successfully recomped as a beginner and has helped hundreds of clients achieve similar results through evidence-based approaches. As founder of LogYourBody, he specializes in making complex body composition science accessible and actionable.*`},"muscle-protein-synthesis-complete-guide":{slug:"muscle-protein-synthesis-complete-guide",title:"The Complete Guide to Muscle Protein Synthesis: How to Maximize Your Gains with Science",date:"2025-01-16",author:"Tim White",tags:["Muscle Protein Synthesis","Protein","Muscle Building","Nutrition","Science"],excerpt:"Learn the science behind muscle protein synthesis and discover evidence-based strategies to optimize your muscle-building potential through proper nutrition timing and leucine thresholds.",readTime:"8 min read",formattedDate:"January 16, 2025",content:`# The Complete Guide to Muscle Protein Synthesis: How to Maximize Your Gains with Science
...
*Tim White has been applying muscle protein synthesis research to his own training for over a decade. As founder of LogYourBody, he believes in making complex exercise science accessible and actionable for everyone.*`},"ice-baths-hypertrophy-recovery-truth":{slug:"ice-baths-hypertrophy-recovery-truth",title:"Ice Baths Are Sabotaging Your Muscle Gains: The Cold Truth About Recovery",date:"2025-01-13",author:"Tim White",tags:["Ice Baths","Hypertrophy","Recovery","Muscle Building","Cold Therapy"],excerpt:"Ice baths might feel good, but they're destroying your muscle building progress. Here's the science on why cold therapy should be avoided unless you're a pro athlete.",readTime:"7 min read",formattedDate:"January 13, 2025",content:`# Ice Baths Are Sabotaging Your Muscle Gains: The Cold Truth About Recovery
...
*Tim White spent years using ice baths religiously until discovering they were hindering his muscle building progress. He now focuses on evidence-based recovery methods and has seen better results than ever.*`}},R=()=>Object.values(g).sort((s,l)=>new Date(l.date).getTime()-new Date(s.date).getTime()),A=s=>g[s]||null,W=()=>{const s=new Set;return Object.values(g).forEach(l=>{l.tags.forEach(a=>s.add(a))}),Array.from(s).sort()},U=()=>{const s=k(),{slug:l}=M(),[a,p]=T.useState(null),h=R(),v=W(),o=l?A(l):null,c=a?h.filter(t=>t.tags.includes(a)):h,r=h[0];return o?e.jsxs("div",{className:"min-h-svh bg-linear-bg font-inter",children:[e.jsx("header",{className:"border-b border-linear-border",role:"banner",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6 py-4",children:e.jsxs("nav",{className:"flex items-center justify-between",children:[e.jsx("button",{onClick:()=>s("/"),onMouseEnter:()=>i("/"),onFocus:()=>i("/"),className:"text-lg sm:text-xl font-semibold text-linear-text hover:text-linear-text-secondary transition-colors",children:"LogYourBody"}),e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsx(n,{variant:"ghost",onClick:()=>s("/blog"),onMouseEnter:()=>i("/blog"),className:"text-sm text-linear-text-secondary hover:text-linear-text",children:"← Back to Blog"}),e.jsx(n,{variant:"ghost",onMouseEnter:()=>i("/login"),onFocus:()=>i("/login"),onClick:()=>s("/login"),className:"text-sm text-linear-text-secondary hover:text-linear-text",children:"Log in"}),e.jsx(n,{onMouseEnter:()=>i("/login"),onFocus:()=>i("/login"),onClick:()=>s("/login"),className:"bg-linear-text text-linear-bg text-sm font-medium px-4 py-2 rounded-lg hover:bg-linear-text-secondary transition-colors",children:"Sign up"})]})]})})}),e.jsx("main",{className:"container mx-auto px-4 sm:px-6 py-12",children:e.jsxs("article",{className:"max-w-4xl mx-auto",children:[e.jsxs("header",{className:"mb-12",children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:o.tags.map(t=>e.jsx(d,{variant:"secondary",className:"text-xs",children:t},t))}),e.jsx("h1",{className:"text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-linear-text mb-6",children:o.title}),e.jsxs("div",{className:"flex items-center gap-6 text-sm text-linear-text-secondary",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(x,{className:"h-4 w-4"}),o.author]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(w,{className:"h-4 w-4"}),o.formattedDate]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(m,{className:"h-4 w-4"}),o.readTime]})]})]}),e.jsx("div",{className:"prose prose-lg max-w-none",children:e.jsx("div",{className:"text-linear-text-secondary leading-relaxed",dangerouslySetInnerHTML:{__html:o.content.replace(/^# /gm,'<h1 class="text-3xl font-bold text-linear-text mt-8 mb-4">').replace(/^## /gm,'<h2 class="text-2xl font-semibold text-linear-text mt-8 mb-4">').replace(/^### /gm,'<h3 class="text-xl font-semibold text-linear-text mt-6 mb-3">').replace(/\*\*(.*?)\*\*/g,'<strong class="font-semibold text-linear-text">$1</strong>').replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,'<code class="bg-linear-card px-2 py-1 rounded text-sm font-mono">$1</code>').replace(/```([^```]+)```/gs,'<pre class="bg-linear-card p-4 rounded-lg overflow-x-auto"><code class="font-mono text-sm">$1</code></pre>').replace(/^\| (.*) \|$/gm,'<div class="table-row">$1</div>').replace(/\n\n/g,'</p><p class="mb-4">').replace(/^(?!<[h|p|d])/gm,'<p class="mb-4">')+"</p>"}})}),e.jsxs("div",{className:"mt-12 p-8 bg-linear-card/30 rounded-xl border border-linear-border",children:[e.jsx("h3",{className:"text-xl font-semibold text-linear-text mb-4",children:"Ready to Start Tracking?"}),e.jsx("p",{className:"text-linear-text-secondary mb-6",children:"Join thousands of people using LogYourBody to track what really matters for their fitness journey."}),e.jsxs(n,{onClick:()=>s("/login"),onMouseEnter:()=>i("/login"),className:"bg-linear-text text-linear-bg hover:bg-linear-text-secondary",children:["Start Free Trial",e.jsx(u,{className:"h-4 w-4 ml-2"})]})]})]})}),e.jsx(b,{})]}):e.jsxs("div",{className:"min-h-svh bg-linear-bg font-inter",children:[e.jsx("header",{className:"border-b border-linear-border",role:"banner",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6 py-4",children:e.jsxs("nav",{className:"flex items-center justify-between",children:[e.jsx("button",{onClick:()=>s("/"),onMouseEnter:()=>i("/"),onFocus:()=>i("/"),className:"text-lg sm:text-xl font-semibold text-linear-text hover:text-linear-text-secondary transition-colors",children:"LogYourBody"}),e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsx(n,{variant:"ghost",onMouseEnter:()=>i("/login"),onFocus:()=>i("/login"),onClick:()=>s("/login"),className:"text-sm text-linear-text-secondary hover:text-linear-text",children:"Log in"}),e.jsx(n,{onMouseEnter:()=>i("/login"),onFocus:()=>i("/login"),onClick:()=>s("/login"),className:"bg-linear-text text-linear-bg text-sm font-medium px-4 py-2 rounded-lg hover:bg-linear-text-secondary transition-colors",children:"Sign up"})]})]})})}),e.jsxs("main",{children:[e.jsx("section",{className:"py-16 md:py-24",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6",children:e.jsxs("div",{className:"mx-auto max-w-4xl text-center",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 mb-6",children:[e.jsx(N,{className:"h-8 w-8 text-linear-purple"}),e.jsx(d,{className:"bg-linear-purple/10 text-white border-linear-purple/20",children:"Evidence-Based Content"})]}),e.jsxs("h1",{className:"mb-6 text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-linear-text",children:["The LogYourBody",e.jsx("br",{}),e.jsx("span",{className:"bg-linear-to-r from-linear-purple via-linear-text to-linear-purple bg-clip-text text-transparent",children:"Blog"})]}),e.jsx("p",{className:"mx-auto mb-8 max-w-2xl text-lg text-linear-text-secondary",children:"Science-based articles about body composition, fitness tracking, and building sustainable habits. No fluff, just actionable insights backed by research."})]})})}),e.jsx("section",{className:"py-8 border-y border-linear-border bg-linear-card/20",children:e.jsx("div",{className:"container mx-auto px-4 sm:px-6",children:e.jsxs("div",{className:"flex flex-wrap gap-2 justify-center",children:[e.jsx(n,{variant:a===null?"default":"outline-solid",size:"sm",onClick:()=>p(null),className:a===null?"bg-linear-text text-linear-bg":"",children:"All Posts"}),v.map(t=>e.jsxs(n,{variant:a===t?"default":"outline-solid",size:"sm",onClick:()=>p(t),className:a===t?"bg-linear-text text-linear-bg":"",children:[e.jsx(I,{className:"h-3 w-3 mr-1"}),t]},t))]})})}),!a&&e.jsx("section",{className:"py-16",children:e.jsxs("div",{className:"container mx-auto px-4 sm:px-6",children:[e.jsx("div",{className:"mb-8",children:e.jsx("h2",{className:"text-2xl font-bold text-linear-text mb-4",children:"Featured Article"})}),e.jsx(f,{className:"border-linear-border bg-linear-card/50 overflow-hidden",children:e.jsxs("div",{className:"md:flex",children:[e.jsx("div",{className:"md:w-1/3 bg-linear-to-br from-linear-purple/20 to-linear-purple/5 p-8 flex items-center justify-center",children:e.jsx(j,{className:"h-16 w-16 text-white"})}),e.jsxs("div",{className:"md:w-2/3 p-8",children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:r.tags.map(t=>e.jsx(d,{variant:"secondary",className:"text-xs",children:t},t))}),e.jsx("h3",{className:"text-2xl font-bold text-linear-text mb-4",children:r.title}),e.jsx("p",{className:"text-linear-text-secondary mb-6",children:r.excerpt}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4 text-sm text-linear-text-secondary",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(x,{className:"h-4 w-4"}),r.author]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(m,{className:"h-4 w-4"}),r.readTime]})]}),e.jsxs(n,{onClick:()=>s(`/blog/${r.slug}`),onMouseEnter:()=>i(`/blog/${r.slug}`),className:"bg-linear-text text-linear-bg hover:bg-linear-text-secondary",children:["Read Article",e.jsx(u,{className:"h-4 w-4 ml-2"})]})]})]})]})})]})}),e.jsx("section",{className:"py-16",children:e.jsxs("div",{className:"container mx-auto px-4 sm:px-6",children:[e.jsxs("div",{className:"mb-8",children:[e.jsx("h2",{className:"text-2xl font-bold text-linear-text mb-4",children:a?`Posts tagged "${a}"`:"Latest Articles"}),e.jsxs("p",{className:"text-linear-text-secondary",children:[c.length," article",c.length!==1?"s":""]})]}),e.jsx("div",{className:"grid gap-8 md:grid-cols-2 lg:grid-cols-3",children:c.map(t=>e.jsxs(f,{className:"border-linear-border bg-linear-card group hover:shadow-lg transition-all",children:[e.jsxs(S,{children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-3",children:t.tags.slice(0,2).map(y=>e.jsx(d,{variant:"secondary",className:"text-xs",children:y},y))}),e.jsx(F,{className:"text-lg text-linear-text group-hover:text-linear-purple transition-colors",children:t.title}),e.jsx(P,{className:"text-linear-text-secondary",children:t.excerpt})]}),e.jsxs(B,{children:[e.jsx("div",{className:"flex items-center justify-between mb-4",children:e.jsxs("div",{className:"flex items-center gap-3 text-sm text-linear-text-secondary",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(w,{className:"h-3 w-3"}),t.formattedDate]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(m,{className:"h-3 w-3"}),t.readTime]})]})}),e.jsxs(n,{variant:"ghost",className:"w-full justify-between text-linear-text-secondary hover:text-linear-text hover:bg-linear-purple/10 transition-colors",onClick:()=>s(`/blog/${t.slug}`),onMouseEnter:()=>i(`/blog/${t.slug}`),children:["Read Article",e.jsx(u,{className:"h-4 w-4"})]})]})]},t.slug))}),c.length===0&&e.jsxs("div",{className:"text-center py-12",children:[e.jsx(C,{className:"h-12 w-12 text-linear-text-secondary mx-auto mb-4"}),e.jsx("h3",{className:"text-xl font-semibold text-linear-text mb-2",children:"No articles found"}),e.jsx("p",{className:"text-linear-text-secondary",children:"Try selecting a different tag or view all posts."})]})]})}),e.jsx("section",{className:"py-16 bg-linear-card/30",children:e.jsxs("div",{className:"container mx-auto px-4 sm:px-6 text-center",children:[e.jsx("h2",{className:"text-3xl font-bold text-linear-text mb-4",children:"Stay Updated"}),e.jsx("p",{className:"text-linear-text-secondary mb-8 max-w-2xl mx-auto",children:"Get notified when we publish new evidence-based articles about body composition, fitness tracking, and sustainable health habits."}),e.jsxs(n,{onClick:()=>s("/login"),onMouseEnter:()=>i("/login"),className:"bg-linear-text text-linear-bg hover:bg-linear-text-secondary",children:["Join LogYourBody",e.jsx(u,{className:"h-4 w-4 ml-2"})]})]})})]}),e.jsx(b,{})]})};export{U as default};
