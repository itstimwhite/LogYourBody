...
export function useSwipeNavigation({
  ...
  const isConflictingElement = useCallback((target: EventTarget | null): boolean => {
  ...
  const isEdgeSwipe = useCallback((startX: number): boolean => {
  ...
  useEffect(() => {
    ...
    const handleTouchStart = (e: TouchEvent) => {
      ...
      if (isConflictingElement(e.target) && !isEdgeSwipe(e.changedTouches[0].screenX)) {
