...
export const tw = {
  ...
  sectionTitle: 'text-[12pt] font-semibold uppercase tracking-wider opacity-80 text-white',
  ...
  // Components
  settingItem: 'flex items-center justify-between min-h-[56px] px-4 py-3 rounded-xl hover:bg-secondary/20 transition-colors',
  card: 'p-5 rounded-2xl border border-border bg-secondary/10',
  input: 'h-12 px-4 rounded-xl border border-border bg-secondary text-white text-[16pt] focus:border-primary focus:outline-none',
