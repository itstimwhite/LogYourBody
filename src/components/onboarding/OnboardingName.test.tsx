...
describe("OnboardingName", () => {
  ...
  it("validates full name requirement", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Please enter your full name (first and last)"),
      ).toBeInTheDocument();
    });
  ...
  it("validates minimum character requirement", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Please enter at least 2 characters"),
      ).toBeInTheDocument();
    });
  });
  ...
  it("validates special character restrictions", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Please use only letters, hyphens, and apostrophes"),
      ).toBeInTheDocument();
    });
  });
