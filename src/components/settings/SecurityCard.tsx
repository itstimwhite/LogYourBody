...
export const SecurityCard = React.memo<SecurityCardProps>(function SecurityCard({
  biometricEnabled,
  onBiometricToggle,
  twoFactorEnabled,
  onTwoFactorToggle,
      ...
      try {
        ...
        if (typeof window !== 'undefined' && (window as any).Capacitor) {
          ...
          if (Capacitor.isNativePlatform()) {
            ...
            try {
              const { BiometricAuth, BiometricAuthenticationType } = (window as any).Capacitor.Plugins;
              ...
              if (BiometricAuth) {
                ...
                if (result.isAvailable) {
                  ...
                  if (Capacitor.getPlatform() === 'ios') {
                    ...
                    if (result.biometryType === BiometricAuthenticationType.FACE_ID) {
                      type = 'faceId';
                      deviceName = 'Face ID';
                    } else {
                      type = 'touchId';
              ...
              console.warn('BiometricAuth plugin not available:', pluginError);
              setBiometricSupport({
                isAvailable: false,
                type: 'none',
                deviceName: 'Device',
        ...
        if (typeof window !== 'undefined' && (window as any).Capacitor) {
          ...
          if (BiometricAuth) {
            const result = await BiometricAuth.authenticate({
              ...
              description: 'This will enable biometric authentication for future logins',
            });
    ...
    <SettingGroup title="Security & Privacy" className={className}>
      ...
      {biometricSupport.isAvailable && (
        <SettingItem
          ...
          subtitle={biometricEnabled ? 'Enabled for quick access' : 'Disabled'}
          icon={
            <div className={cn(
              'text-blue-400',
      ...
      <SettingItem
        ...
        subtitle={twoFactorEnabled ? 'Extra security enabled' : 'Add an extra layer of security'}
        icon={
          <div className={cn(
            'text-green-400',
