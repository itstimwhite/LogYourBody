...
export const SubscriptionCard = React.memo<SubscriptionCardProps>(function SubscriptionCard({
  isSubscribed,
  subscriptionType,
  expiryDate,
  ...
  const getSubscriptionStatus = () => {
    ...
    const isExpiringSoon = expiryDate && expiryDate.getTime() - now.getTime() < 7 * 24 * 60 * 60 * 1000; // 7 days
    ...
    return {
      title: getSubscriptionTitle(),
      subtitle: subscriptionType === 'lifetime' 
